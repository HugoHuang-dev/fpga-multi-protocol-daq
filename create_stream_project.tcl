...
# File    : create_stream_project.tcl
...
create_project project1_uart_stream [file join $script_dir vivado_stream] -part xc7a35tfgg484-2 -force
...
set_property top top_stream [current_fileset]
update_compile_order -fileset sources_1
puts "Project created: [file join $script_dir vivado_stream project1_uart_stream.xpr]"
