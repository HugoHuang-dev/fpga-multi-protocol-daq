...
# File    : build_stream_bitstream.tcl
...
open_project [file join $script_dir vivado_stream project1_uart_stream.xpr]
...
puts "Bitstream: [file join $script_dir vivado_stream project1_uart_stream.runs impl_1 top_stream.bit]"
