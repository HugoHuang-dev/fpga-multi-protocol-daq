...
open_project [file join $script_dir vivado_rtc project1_uart_rtc.xpr]
reset_run synth_1
...
puts "Bitstream: [file join $script_dir vivado_rtc project1_uart_rtc.runs impl_1 top_rtc.bit]"
