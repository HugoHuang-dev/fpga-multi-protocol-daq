...
# File    : build_crc16_bitstream.tcl
...
open_project [file join $script_dir vivado_crc16 project1_uart_crc16.xpr]
...
puts "Bitstream: [file join $script_dir vivado_crc16 project1_uart_crc16.runs impl_1 top_crc16.bit]"
