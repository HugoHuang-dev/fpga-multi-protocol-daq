...
# File    : build_multichannel_bitstream.tcl
...
open_project [file join $script_dir vivado_multichannel project1_uart_multichannel.xpr]
reset_run synth_1
...
puts "Bitstream: [file join $script_dir vivado_multichannel project1_uart_multichannel.runs impl_1 top_multichannel.bit]"
