...
# File    : build_eeprom_bitstream.tcl
...
open_project [file join $script_dir vivado_eeprom project1_uart_eeprom.xpr]
reset_run synth_1
...
puts "Bitstream: [file join $script_dir vivado_eeprom project1_uart_eeprom.runs impl_1 top_eeprom.bit]"
