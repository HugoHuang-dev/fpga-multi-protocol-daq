...
# File    : create_eeprom_project.tcl
...
create_project project1_uart_eeprom [file join $script_dir vivado_eeprom] -part xc7a35tfgg484-2 -force
...
set_property top top_eeprom [current_fileset]
update_compile_order -fileset sources_1
puts "Project created: [file join $script_dir vivado_eeprom project1_uart_eeprom.xpr]"
