...
create_project project1_uart_crc16 [file join $script_dir vivado_crc16] -part xc7a35tfgg484-2 -force
...
set_property top top_crc16 [current_fileset]
update_compile_order -fileset sources_1
puts "Project created: [file join $script_dir vivado_crc16 project1_uart_crc16.xpr]"
